...
export async function jsonFetch(url, options = {}) {
  ...
  catch { throw new AppError('UPSTREAM_UNAVAILABLE', 'A required service is unavailable. A submitted chart write may be unconfirmed; retry the same message and delivery inputs.', 503); }
