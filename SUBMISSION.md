...
- Live demo: https://coldchain-jp56.onrender.com
- Source: https://github.com/oliullah5603/coldchain
- Access: select **Connect to EHR** (synthetic demo; no password required). Allow about a minute for the free service to wake up.
